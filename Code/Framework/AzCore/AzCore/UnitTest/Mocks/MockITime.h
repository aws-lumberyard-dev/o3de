...
namespace AZ
{
    ...
    public:
        ...
        MOCK_CONST_METHOD0(GetSimulationTickDeltaTimeMs, TimeMs());
        MOCK_CONST_METHOD0(GetRealTickDeltaTimeMs, TimeMs());
        MOCK_CONST_METHOD0(GetLastSimulationTickTime, TimeMs());
