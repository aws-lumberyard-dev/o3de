    ...
    public:
        ...
        */
        ...
        BehaviorDefaultValue(Value&& value)
        {
            ...
            {
                // BehaviorValueParameter does not destroy instances of types
                // set with StoreInTempData(). It does not take ownership of
                // that instance, because it is designed to reference existing
...
#define AZ_BEHAVIOR_EBUS_EVENT_FUNCTION_TYPE_I(memberName) decltype(&ThisType::memberName)
    ...
    template<typename T>
    inline void BehaviorValueParameter::StoreInTempDataEvenIfNonTrivial(T&& value)
    {
