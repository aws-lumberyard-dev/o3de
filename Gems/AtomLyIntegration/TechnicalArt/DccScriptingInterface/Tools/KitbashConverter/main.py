...
"""! @brief Entry point for the Kitbash Converter Tool. """
...
# @brief Entry point for the Kitbash Converter Tool.
#
# @section kitbash_converter_tool Description
# Python program that gives users easy access to all available tools in the
# DCCsi (Digital Content Creation Scripting Interface)
#
# @section notes_kitbash_converter Notes
...
# TODO - Create materials for shaders without textures attached- most likely glass
# TODO - Plants... get opacity/clipping set up correctly. Light transmission
# TODO - Handle "Split texture alpha" Break alpha out of the color and map into the materials
...
class KitbashConverter(QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        self.setObjectName('KitbashConverter')
        self.setWindowTitle('Kitbash3d Assets to O3DE')
        self.isTopLevel()
    ...
    def process_directory(self, directory_path):
        ...
        @param  directory_path The directory path containing assets to process
        """
    ...
    def display_message(self, message):
        ...
        @param message The message to be displayed in the window footer
        """
        self.message_readout_label.setText(message)
        self.app.processEvents()

    def initialize_qprocess(self):
        """! This sets the QProcess object up and adds all of the aspects that will remain consistent for each
        directory processed.
        """
        self.p = QProcess()
    ...
    def handle_state(self, state):
        ...
        @param state The running state of the connection
        """
        states = {
    ...
    def start_maya_session(self, target_fbx):
        ...
        @param target_fbx The file to be sent to Maya for processing
        """
    ...
    def export_o3de_material(self, output, material_description):
        ...
        @param output The output file path for the the generated material
        @param material_description The information (dictionary) that describes the material
        """
    ...
    def get_material_definition(self, material_file):
        ...
        material_file = Path(settings.DCCSIG_PATH,
                             'Tools', 'KitbashConverter', material_file).resolve()
    ...
    def get_audit_index(self, target_index):
        _LOGGER.info(f'HMMM: {self.audit_list}')
    ...
    def set_io_directories(self):
        """! This is constantly running when user interacts with the source and destination fields in the UI,
        validating that the paths are legitimate. In the event that there are malformed or non-existing paths-
        it disables the processing button.
        """
...
class AttributeListing(QtWidgets.QWidget):
    ...
    def __init__(self, attribute_values: dict, parent=None):
    ...
    def format_material_value(self, value):
        ...
        @return Formatted value that has been filtered if needed
        """
