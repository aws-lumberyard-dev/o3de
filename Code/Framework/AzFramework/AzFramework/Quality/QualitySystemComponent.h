...
namespace AzFramework
{
    ...
    public:
        ...
        int GetGroupQualityLevel(AZStd::string_view group = QualitySystemEvents::DefaultGroup) const override;
        void LoadGroupQualityLevel(AZStd::string_view group = QualitySystemEvents::DefaultGroup, int level = QualitySystemEvents::LevelFromDeviceRules) override;
