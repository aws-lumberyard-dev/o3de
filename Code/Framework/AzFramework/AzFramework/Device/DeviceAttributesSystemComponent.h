...
namespace AzFramework
{
    ...
    public:
        ...
        bool RegisterDeviceAttribute(AZStd::unique_ptr<DeviceAttributeInterface> deviceAttributeInterface) override;
        void VisitDeviceAttributes(const VisitInterfaceCallback&) const override;
        DeviceAttributeInterface* FindDeviceAttribute(AZStd::string_view deviceAttribute) const override;
    ...
    private:
        ...
        AZStd::unordered_map<AZStd::string, AZStd::unique_ptr<DeviceAttributeInterface>> m_deviceAttributeInterfaces;
    };
} // AzFramework
