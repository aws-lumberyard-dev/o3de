...
namespace AZ
{
    namespace PhysX
    {
        const char* MaterialTypeAsset::DisplayName = "PhysXMaterialTypeAsset";
        const char* MaterialTypeAsset::Group = "PhysXMaterial";
        const char* MaterialTypeAsset::Extension = "azphysxmaterialtype";
        ...
        MaterialTypeAsset::~MaterialTypeAsset()
        {
            ...
            RPI::AssetInitBus::Handler::BusDisconnect();
        }
        ...
        bool MaterialTypeAsset::ApplyPropertyRenames([[maybe_unused]] AZ::Name& propertyId) const
        {
            bool renamed = false;
            ...
            const AZ::Data::AssetFilterCB& assetLoadFilterCB)
        {
            ...
            {
                asset.GetAs<MaterialTypeAsset>()->RPI::AssetInitBus::Handler::BusConnect();
