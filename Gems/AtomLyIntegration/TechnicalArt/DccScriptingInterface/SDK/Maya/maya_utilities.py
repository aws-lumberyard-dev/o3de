...
##
# @file maya_utilities.py
#
# @brief This module contains several common utilities/operations for use with Maya.
#
...
_LOGGER = _logging.getLogger('SDK.DCC.Maya.maya_utilities')
