...
AZ_GFX_FLOAT_PARAM(WhiteBalanceKelvin, m_kelvinWhiteBalance, 6500.0)
...
AZ_GFX_FLOAT_PARAM(ChannelMixingRed, m_channelMixingRed, 1.0)
AZ_GFX_FLOAT_PARAM(ChannelMixingGreen, m_channelMixingGreen, 1.0)
AZ_GFX_FLOAT_PARAM(ChannelMixingBlue, m_channelMixingBlue, 1.0)
