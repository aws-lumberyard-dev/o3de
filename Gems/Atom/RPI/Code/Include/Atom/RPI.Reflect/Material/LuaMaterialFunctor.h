...
namespace AZ
{
    ...
    namespace RPI
    {
        namespace LuaMaterialFunctorAPI
        {
            ...
            //! Wraps MaterialFunctorAPI::MainRuntimeContext with lua bindings
            ...
            {
            public:
                AZ_TYPE_INFO(LuaMaterialFunctorAPI::MainRuntimeContext, "{00FF6AE5-DE0A-41E2-B3F8-FBB9E265C399}");
            ...
            private:
                ...
                MaterialFunctorAPI::MainRuntimeContext* m_runtimeContextImpl = nullptr;
                const MaterialNameContext* m_materialNameContext;
            };
            ...
            class Utilities
            {
                ...
                friend LuaMaterialFunctorAPI::MainRuntimeContext;
