...
namespace ScriptAutomation
{
    ...
    {
        AZ_TracePrintf("ScriptAutomation", "AssetCompilationStarted(%s)\n", assetPath.c_str());
    ...
    {
        AZ_TracePrintf("ScriptAutomation", "AssetCompilationSuccess(%s)\n", assetPath.c_str());
    ...
    {
        AZ_TracePrintf("ScriptAutomation", "AssetCompilationFailed(%s)\n", assetPath.c_str());
