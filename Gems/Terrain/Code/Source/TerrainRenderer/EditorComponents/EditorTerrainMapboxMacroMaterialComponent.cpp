...
namespace Terrain
{
    void EditorTerrainMapboxMacroMaterialComponent::Reflect(AZ::ReflectContext* context)
    {
        BaseClassType::ReflectSubClass<EditorTerrainMapboxMacroMaterialComponent, BaseClassType>(
            context, 1,
