...
namespace AZ
{
    ...
    public:
        ...
        //! @param component pointer to the component instance to destroy.
    ...
    class ComponentDescriptorImplementation
        : public ComponentDescriptorBus::Handler
    {
    public:
        ComponentDescriptorImplementation()
        {
        ...
        {
            ComponentClass* result = nullptr;
            if (!m_freeComponents.empty())
            {
                result = new (m_freeComponents.back()) ComponentClass(AZStd::forward<Args>(args)...);
                m_freeComponents.pop_back();
            }
            else
            {
                m_components.emplace_back();
                result = &(m_components.back());
            }
            return result;
        }
        ...
        Component* CreateComponent() override
        {
            ...
            if (!m_freeComponents.empty())
            {
                result = new (m_freeComponents.back()) ComponentClass();
                m_freeComponents.pop_back();
            }
            else
            {
        ...
        {
            component->~Component();
            m_freeComponents.push_back(component);
        }
    ...
    private:
        AZStd::deque<ComponentClass> m_components;
        AZStd::vector<Component*> m_freeComponents;
    };
    ...
    class ComponentDescriptorDefault
        : public ComponentDescriptorImplementation<ComponentClass>
    {
    public:
        ...
        {
            static_assert(HasComponentReflect<ComponentClass>::value,
                "All components using ComponentDescriptorDefault (AZ_COMPONENT macro) should implement 'static void Reflect(ReflectContext* reflection)' function!");
