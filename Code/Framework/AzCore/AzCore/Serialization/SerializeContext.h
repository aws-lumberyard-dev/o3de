...
namespace AZ
{
    ...
    public:
        ...
        */
        ...
        struct ClassElement
        {
            ...
            AZStd::vector<AttributeSharedPair, AZ::AllocatorPointerWrapper> m_attributes; ///< Attributes attached to ClassElement.
        ...
        public:
            ...
            AZStd::vector<AttributeSharedPair, AZ::AllocatorPointerWrapper> m_attributes;
        };
    ...
    public:
        class ClassBuilder
        {
            ...
            AZStd::vector<AttributeSharedPair, AZ::AllocatorPointerWrapper>* m_currentAttributes = nullptr;
        public:
            ~ClassBuilder();
    ...
    private:
        ...
        AZStd::vector<AZStd::unique_ptr<IDataContainer>, AZ::AllocatorPointerWrapper> m_dataContainers; ///< Takes care of all related IDataContainer's lifetimes
    ...
    */
    ...
    {
    public:
        using GenericInfoModuleMap = AZStd::unordered_map<AZ::Uuid, AZ::GenericClassInfo*, AZStd::hash<AZ::Uuid>, AZStd::equal_to<AZ::Uuid>, AZ::AllocatorPointerWrapper>;
    ...
    AttributePtr CreateModuleAttribute(T&& attrValue)
    {
        ...
        return AttributePtr{ static_cast<ContainerType*>(rawMemory), AZStd::move(attributeDeleter), AllocatorPointerWrapper(&moduleAllocator) };
    }
}   // namespace AZ
