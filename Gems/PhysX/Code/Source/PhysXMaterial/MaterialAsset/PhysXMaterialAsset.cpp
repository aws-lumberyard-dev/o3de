...
namespace AZ
{
    namespace PhysX
    {
        const char* MaterialAsset::s_debugTraceName = "PhysXMaterialAsset";

        const char* MaterialAsset::DisplayName = "PhysXMaterialAsset";
        const char* MaterialAsset::Group = "PhysXMaterial";
        const char* MaterialAsset::Extension = "azphysxmaterial";
            ...
            const AZ::Data::AssetFilterCB& assetLoadFilterCB)
        {
            ...
            {
                asset.GetAs<MaterialAsset>()->RPI::AssetInitBus::Handler::BusConnect();
