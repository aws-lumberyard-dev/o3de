...
namespace AZ
{
    namespace PhysX
    {
        const char* Material::s_debugTraceName = "PhysXMaterial";
        ...
        ResultCode Material::Init(MaterialAsset& materialAsset)
        {
        ...
        AZStd::intrusive_ptr<const MaterialPropertiesLayout> Material::GetMaterialPropertiesLayout() const
        {
            return m_layout;
        }
    } // namespace PhysX
