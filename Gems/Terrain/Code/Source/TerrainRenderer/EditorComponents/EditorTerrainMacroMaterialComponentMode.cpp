...
namespace Terrain
{
        ...
        void ApplyChangeBuffer(bool undo)
        {
            ...
            for (int32_t tileIndex = 0; tileIndex < m_paintedImageTiles.size(); tileIndex++)
            {
                ...
                TerrainMacroMaterialModificationBus::Event(
                    ...
                    &TerrainMacroMaterialModificationBus::Events::SetPixelValuesByPixelIndex,
                    pixelIndices,
    ...
    private:
        ...
        void CreateImageTile(uint32_t tileIndex)
        {
            ...
            TerrainMacroMaterialModificationBus::Event(
                m_imageGradientEntityId,
                &TerrainMacroMaterialModificationBus::Events::GetPixelValuesByPixelIndex,
                pixelIndices,
        ...
        , m_ownerEntityComponentId(entityComponentIdPair)
    {
        ...
        TerrainMacroMaterialModificationBus::Event(GetEntityId(), &TerrainMacroMaterialModificationBus::Events::StartImageModification);
    ...
    EditorTerrainMacroMaterialComponentMode::~EditorTerrainMacroMaterialComponentMode()
    {
        ...
        TerrainMacroMaterialModificationBus::Event(GetEntityId(), &TerrainMacroMaterialModificationBus::Events::EndImageModification);
    ...
    void EditorTerrainMacroMaterialComponentMode::OnPaintStrokeBegin(float intensity, float opacity)
    {
        ...
        TerrainMacroMaterialRequestBus::EventResult(imageWidth, GetEntityId(), &TerrainMacroMaterialRequestBus::Events::GetMacroColorImageWidth);

        uint32_t imageHeight = 0;
        TerrainMacroMaterialRequestBus::EventResult(imageHeight, GetEntityId(), &TerrainMacroMaterialRequestBus::Events::GetMacroColorImageHeight);
    ...
    void EditorTerrainMacroMaterialComponentMode::OnPaintStrokeEnd()
    {
    ...
    void EditorTerrainMacroMaterialComponentMode::OnPaint(const AZ::Aabb& dirtyArea, ValueLookupFn& valueLookupFn, BlendFn& blendFn)
    {
        ...
        TerrainMacroMaterialModificationBus::Event(
            entityId, &TerrainMacroMaterialModificationBus::Events::GetPixelIndicesForPositions, validPoints, pixelIndices);
        ...
        {
            auto [originalColor, opacityValue] = m_paintStrokeData.m_strokeBuffer->GetOriginalPixelValueAndOpacity(pixelIndices[index]);
    ...
    void EditorTerrainMacroMaterialComponentMode::CreateSubModeSelectionCluster()
    {
    ...
    void EditorTerrainMacroMaterialComponentMode::RemoveSubModeSelectionCluster()
    {
        AzToolsFramework::ViewportUi::ViewportUiRequestBus::Event(
            AzToolsFramework::ViewportUi::DefaultViewportId,
