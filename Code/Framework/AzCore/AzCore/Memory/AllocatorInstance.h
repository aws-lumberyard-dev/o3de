...
namespace AZ
{
    ...
    class AllocatorInstance
    {
        ...
        struct StaticMembers : private AZ::Environment::EnvironmentCallback // Added callback so this object can hook up to the environment
                                                                            // attach/detach method
        {
            ...
            using AllocatorStorage =
                typename AZStd::aligned_storage<sizeof(AllocatorType), AZStd::alignment_of<AllocatorType>::value>::type;

            AllocatorType*
                m_cachedEnvironmentAllocator; // pointer to the allocator after it was obtained/created in the environment variable
            ...
            AZ::EnvironmentVariable<AllocatorLifetime>
                m_environmentAllocator; // environment variable that contains the allocator's instance
        };
