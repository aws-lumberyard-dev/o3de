...
namespace AzToolsFramework
{
    namespace AssetDatabase
    {
        ...
        ProductDatabaseEntry::ProductDatabaseEntry(AZ::s64 productID, AZ::s64 jobPK, AZ::u32 subID, const char* productName,
            AZ::Data::AssetType assetType, AZ::Uuid legacyGuid, AZStd::bitset<64> flags)
        ...
        {
            return AZStd::string::format("ProductDatabaseEntry id:%" PRId64 " jobpk: %" PRId64 " subid: %i productname: %s assettype: %s flags: %" PRId64,
                                         static_cast<int64_t>(m_productID), static_cast<int64_t>(m_jobPK), m_subID, m_productName.c_str(), m_assetType.ToString<AZStd::string>().c_str(), m_flags.to_ullong());
        }
