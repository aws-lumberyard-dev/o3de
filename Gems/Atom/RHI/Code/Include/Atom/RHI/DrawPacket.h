...
namespace AZ
{
    ...
    namespace RHI
    {
        ...
        public:
            ...
            //! Returns the draw list tag associated with the provided index, used to sort the draw item into an appropriate pass.
            DrawListTag GetDrawListTag(size_t index) const;

            //! Returns the draw filter mask associated with the provided index, used to sort the draw item into an appropriate render pipeline.
