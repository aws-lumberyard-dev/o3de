...
#include <Editor/Source/PhysXMaterialBuilder/PhysXMaterialBuilder.h>
...
namespace AZ
{
    namespace PhysX
    {
        namespace
        {
            [[maybe_unused]] static constexpr char const MaterialBuilderName[] = "PhysXMaterialBuilder";
        }

        const char* MaterialBuilder::JobKey = "PhysX Material Builder";
        ...
        void MaterialBuilder::RegisterBuilder()
        {
            ...
            materialBuilderDescriptor.m_patterns.push_back(AssetBuilderSDK::AssetBuilderPattern("*.physxmaterial", AssetBuilderSDK::AssetBuilderPattern::PatternType::Wildcard));
            materialBuilderDescriptor.m_patterns.push_back(AssetBuilderSDK::AssetBuilderPattern("*.physxmaterialtype", AssetBuilderSDK::AssetBuilderPattern::PatternType::Wildcard));
        ...
        bool MaterialBuilder::ReportMaterialAssetWarningsAsErrors() const
        {
            ...
            {
                settingsRegistry->Get(warningsAsErrors, "/O3DE/PhysX/MaterialBuilder/WarningsAsErrors");
            }
        ...
        void MaterialBuilder::ProcessJob(const AssetBuilderSDK::ProcessJobRequest& request, AssetBuilderSDK::ProcessJobResponse& response) const
        {
            ...
            if (isMaterialTypeFile)
            {
                ...
                if (!AssetBuilderSDK::OutputObject(materialTypeAsset.Get(), materialProductPath, azrtti_typeid<PhysX::MaterialTypeAsset>(), 0, jobProduct))
                {
            ...
            else
            {
                ...
                AssetBuilderSDK::JobProduct jobProduct;
                if (!AssetBuilderSDK::OutputObject(materialAsset.Get(), materialProductPath, azrtti_typeid<PhysX::MaterialAsset>(), 0, jobProduct))
                {
                    AZ_Error(MaterialBuilderName, false, "Failed to output product dependencies.");
                    return;
                }
