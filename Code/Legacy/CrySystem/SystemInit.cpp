...
bool CSystem::Init(const SSystemInitParams& startupParams)
{
    ...
    AzFramework::QualitySystemEvents::Bus::Broadcast(&AzFramework::QualitySystemEvents::LoadGroupQualityLevel,
        AzFramework::QualitySystemEvents::DefaultGroup, AzFramework::QualitySystemEvents::LevelFromDeviceRules);
