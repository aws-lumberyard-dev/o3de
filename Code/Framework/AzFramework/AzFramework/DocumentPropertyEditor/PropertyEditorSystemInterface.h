...
namespace AZ::DocumentPropertyEditor
{
    ...
    public:
        ...
        template<typename AttributeDefinition, typename PropertyEditor = Nodes::PropertyEditor>
        void RegisterAttributeDefinition(const AttributeDefinition& definition)
        {
            AttributeMetadata metadata = AttributeMetadata::FromDefinition(definition);
            metadata.m_propertyEditor = FindPropertyEditor(GetNodeName<PropertyEditor>());
            RegisterAttribute(AZStd::move(metadata));
        }
    };
} // namespace AZ::DocumentPropertyEditor
