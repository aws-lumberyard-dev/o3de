...
namespace AZ
{
    namespace PhysX
    {
            ...
            Data::AssetId assetId, AZStd::string_view materialSourceFilePath, MaterialAssetProcessingMode processingMode, bool elevateWarnings) const
        {
            ...
            Outcome<Data::AssetId> materialTypeAssetId = RPI::AssetUtils::MakeAssetId(materialSourceFilePath, m_materialType, 0);
            ...
            {
                auto parentMaterialAsset = RPI::AssetUtils::LoadAsset<MaterialAsset>(materialSourceFilePath, m_parentMaterial);
            ...
            AZStd::unordered_set<AZStd::string>* sourceDependencies) const
        {
            ...
            const auto materialTypeSourcePath = RPI::AssetUtils::ResolvePathReference(materialSourceFilePath, m_materialType);
            const auto materialTypeAssetId = RPI::AssetUtils::MakeAssetId(materialTypeSourcePath, 0);
            ...
            AZStd::string parentSourceAbsPath = RPI::AssetUtils::ResolvePathReference(materialSourceFilePath, parentSourceRelPath);
